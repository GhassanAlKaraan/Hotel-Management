...
<?php
    if(isset($_POST["reset"])){
        ...
        if($Email){
            $new_pass = $psw;
            mysqli_query($conn, "UPDATE user SET Password_User='$new_pass' WHERE Email_User='$Email'");
			mysqli_query($conn, "UPDATE user SET Cpassword_User='$new_pass' WHERE Email_User='$Email'");
            ?>
            <script>
